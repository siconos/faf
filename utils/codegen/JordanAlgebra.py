...
def spectral_decomposition(x, epsilon=friction.epsilon, norm=friction.N):
    """
...
def sqrt(x, epsilon=friction.epsilon, norm=friction.N):
    """
    Jordan Algebra sqrt
    """
...
def projection(x, epsilon=friction.epsilon, norm=friction.N):
