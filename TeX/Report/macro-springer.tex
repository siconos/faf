...
{\newtheorem{ndr1oh}{\textbf{\textsc{\footnotesize Redaction note O.H.}}}[section]}

\newenvironment{ndroh}%
{%
\color{applegreen}
\noindent\begin{ndr1oh}\hrule\vspace{1em}%
\ttfamily\small \  \\
\noindent}%
{%
$ $ \\
...
\def\vitwo{{\hbox{\tiny{vi}}}}
\def\qvitwo{{\hbox{\tiny{qvi}}}}
...
\def\actwo{{\hbox{\tiny{ac}}}}
\def\hswtwo{{\hbox{\tiny{hsw}}}}
\def\xswtwo{{\hbox{\tiny{xsw}}}}
