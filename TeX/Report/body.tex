...
The four first tests in Table ~\ref{Tab:fclib}, Cubes\_H8\_2, Cubes\_H8\_5, Cubes\_H8\_20 and  LowWall\_FEM,  are examples that involve flexible elastic bodies meshed by finite element methods. The Delassus  matrix $W$ in that case is full rank. We will call these sets of examples the {\em flexible test sets} in the sequel.
