...
The question of the existence of solution for problem~\ref{prob:I} and~\ref{prob:II} have been studied in~\cite{Klarbring-Pang-98} and~\cite{ZAMM:ZAMM201000073} with different analysis techniques. One the assumption in~\cite{Klarbring-Pang-98} is weaker since the matrix $M$ is only semi--positive definite. The key assumption for existence of solutions is both papers is as follows
