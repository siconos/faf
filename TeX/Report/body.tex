...
\item the approaches that are based on domain decomposition and parallel computing~\citep{Breitkopf.Jean_CSMA99,Renouf.Dubois.ea2004,Koziara.Bicanic_IJNME2011,Wolhmuth.Krause_SJSC2003,Dostal.ea_JCAM2010,Heyn_PhD2013}. We choose in this chapter to focus on single domain computation and to skip the discussion about distributed computing mainly for the sake of length of the chapter.
\end{itemize}}
...
This additional computational effort can be reduced by either driving the proximal parameter $\alpha_k$ as quickly as possible to zero,
