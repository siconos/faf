...
\begin{figure}
  \centering
  \subfigure[Capsules tests (reduced) $tol = 10^{-8},timeout=50s$]{\includegraphics[width=\widthfigure\textwidth]{../figure/VI/UpdateRule/time/profile-Capsules.pdf}\hspace{-3cm}\includegraphics[width=\widthfigure\textwidth]{../figure/VI/UpdateRule/time/profile-Capsules_legend.pdf}}
  \subfigure[LMGC\_Bridge\_PR $tol = 10^{-5}, timeout=50s$]{\includegraphics[width=\widthfigure\textwidth]{../figure/VI/UpdateRule/time/profile-LMGC_Bridge_PR.pdf}\hspace{-3cm}\includegraphics[width=\widthfigure\textwidth]{../figure/VI/UpdateRule/time/profile-LMGC_Bridge_PR_legend.pdf}}
...
\begin{figure}
  \centering
  \vspace{-1cm}
  \subfigure[Capsules tests (reduced) $tol = 10^{-8},timeout=50s$]{\label{fig:NSGS/LocalSolver/time/profile-Capsules}\includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/time/profile-Capsules.pdf}
...
% \begin{figure}
%   \centering
%   \caption{Influence of the local solver in NSGS algorithms ($tol = 10^{-5}$). LMGC\_Bridge\_PR tests. $timeout=50s$}
%   \label{fig:NSGS/LocalSolver/time/profile-LMGC_Bridge_PR}
% \end{figure}
% \begin{figure}
%   \centering
...
\begin{figure}
  \centering
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/time/profile-LMGC_Bridge_PR.pdf}
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/time/profile-LMGC_Bridge_PR_legend.pdf}
