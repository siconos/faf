...
\begin{figure}
  \centering
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/time/profile-Capsules.pdf}
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/time/profile-Capsules_legend.pdf}
  \caption{Influence of the local solver in NSGS algorithms ($tol = 10^{-8}$). Capsules tests. $timeout=50s$}
  \label{fig:NSGS/LocalSolver/time/profile-Capsules}
\end{figure}


\begin{figure}
  \centering
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/time/profile-KaplasTower.pdf}
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/time/profile-KaplasTower_legend.pdf}
  \caption{Influence of the local solver in NSGS algorithms ($tol = 10^{-8}$). KaplasTower tests. $timeout=50s$}
  \label{fig:NSGS/LocalSolver/time/profile-KaplasTower}
\end{figure}
\begin{figure}
  \centering
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/time/profile-Cubes_H8_20.pdf}
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/time/profile-Cubes_H8_20_legend.pdf}
  \caption{Influence of the local solver in NSGS algorithms ($tol = 10^{-4}$). LMGC\_Cubes\_H20 tests. $timeout=50s$}
  \label{fig:NSGS/LocalSolver/time/profile-Cubes_H8_20}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/time/profile-Capsules.pdf}
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/time/profile-Capsules_legend.pdf}
  \caption{Influence of the tolerance of the local solver $tol_{local}$ in NSGS algorithms ($tol = 10^{-8}$). Capsules tests. $timeout=10s$}
  \label{fig:NSGS/LocalTol/time/profile-Capsules}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/time/profile-KaplasTower.pdf}
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/time/profile-KaplasTower_legend.pdf}
  \caption{Influence of the tolerance of the local solver $tol_{local}$ in NSGS algorithms ($tol = 10^{-8}$). KaplasTower tests. $timeout=50s$}
  \label{fig:NSGS/LocalTol/time/profile-KaplasTower}
\end{figure}


\begin{figure}
  \centering
  \includegraphics[width=\widthfigure\textwidth]{../figure/profile-LMGC_Bridge_PR-NSGS-1_3-tol-local-time.pdf}
  \includegraphics[width=\widthfigure\textwidth]{../figure/profile-LMGC_Bridge_PR-NSGS-1_3_legend-tol-local-time.pdf}
  \caption{Influence of the tolerance of the local solver $tol_{local}$ in NSGS algorithms ($tol = 10^{-5}$). LMGC\_Bridge\_PR tests. $timeout=50s$}
  \label{fig:NSGS/LocalTol/time/profile-LMGC_Bridge_PR}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/time/profile-LMGC_Cubes_H8_20.pdf}
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/time/profile-LMGC_Cubes_H8_20_legend.pdf}
  \caption{Influence of the tolerance of the local solver $tol_{local}$ in NSGS algorithms ($tol = 10^{-4}$). LMGC\_Cubes\_H20 tests. $timeout=50s$}
  \label{fig:NSGS/LocalTol/time/profile-Cubes_H8_20}
\end{figure}
...
\begin{figure}
  ...
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/Shuffled/time/profile-Capsules_legend.pdf}
  \caption{Influence of the contacts order in NSGS algorithms ($tol = 10^{-8}$). Capsules tests. $timeout=10s$}
...
\begin{figure}
  ...
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/Shuffled/time/profile-KaplasTower_legend.pdf}
  \caption{Influence of the contacts order in NSGS algorithms ($tol = 10^{-4}$). KaplasTower tests. $timeout=50s$}
...
\begin{figure}
  ...
  \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/Shuffled/time/profile-Cubes_H8_20_legend.pdf}
  \caption{Influence of the contacts order in NSGS algorithms ($tol = 10^{-4}$). LMGC\_Cubes\_H20 tests. $timeout=50s$}
