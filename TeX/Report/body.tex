...
\begin{figure}
  ...
  \subfigure[LMGC\_Cubes\_H8\_20 $tol = 10^{-5}, timeout=50s$]{\includegraphics[width=\widthfigure\textwidth]{../figure/VI/UpdateRule/\performance/profile-LMGC_Cubes_H8_5.pdf}\hspace{-3cm}\includegraphics[width=\widthfigure\textwidth]{../figure/VI/UpdateRule/\performance/profile-LMGC_Cubes_H8_5_legend.pdf}}
...
\begin{figure}
  ...
  \subfigure[LMGC\_Cubes\_H8 tests. $tol = 10^{-4},timeout=50s$]{\label{fig:NSGS/LocalSolver/\performance/profile-LMGC_Cubes_H8_5}\includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/\performance/profile-LMGC_Cubes_H8_5.pdf}
    \hspace{-2cm}\includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalSolver/\performance/profile-LMGC_Cubes_H8_5_legend.pdf}}\vspace{-0.5cm}
...
\begin{figure}
  ...
  \subfigure[LMGC\_Cubes\_H20 tests. $tol = 10^{-4},timeout=50s$]{  \label{fig:NSGS/LocalTol/\performance/profile-LMGC_Cubes_H8_5}\includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/\performance/profile-LMGC_Cubes_H8_5.pdf}
     \hspace{-1cm}\includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/LocalTol/\performance/profile-LMGC_Cubes_H8_5_legend.pdf}}
...
Let us have a look to more difficult examples in Figures~\ref{fig:NSGS/LocalTol/time/profile-LMGC_Bridge_PR} and  \ref{fig:NSGS/LocalTol/time/profile-LMGC_Cubes_H8_5}. Although the required accuracy is lower, the solver with a low local tolerance fails to solve the problems efficiently. In the most difficult test set, it is even required to have a local tolerance $tol_{local}$ at a very low level with respect to the tolerance $tol$ to improve the rate of convergence and even to ensure the success of the solver.
...
\begin{figure}
  ...
  \subfigure[LMGC\_Cubes\_H20 tests. $tol = 10^{-4},timeout=50s$]{%
    \label{fig:NSGS/Shuffled/time/profile-LMGC_Cubes_H8_5}%
    \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/Shuffled/\performance/profile-LMGC_Cubes_H8_5.pdf}
   \hspace{-1cm} \includegraphics[width=\widthfigure\textwidth]{../figure/NSGS/Shuffled/\performance/profile-LMGC_Cubes_H8_5_legend.pdf}
  }
