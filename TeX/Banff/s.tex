...
\begin{block}{Conclusions}
  ...
  \item any ``Swiss--knife'' solution : efficiency OR robustness  
  \item the rank of the $H$ matrix (ratio number of contact unknows/number of d.o.f) plays an important role. 
  \end{enumerate}
\end{block}
\vskip-3mm
\begin{block}{Perspectives}
  ...
  \item Set up a collection of benchmarks  
  \end{enumerate}
\end{block}
...
\frame{
  ...
  \begin{block}
    ...
    \item A open source light implementation of Input/Output functions
      in C Language to read and write problems
    \end{itemize}
  \end{block}
