...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu05/\measurename/profile-#1.pdf}
  \includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu05/\measurename/profile-#1_legend.pdf}
\caption{{#2}{  } \measurename { }PROX/Parametric studies $\nu=0.5$}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu10/\measurename/profile-#1.pdf}
  \includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu10/\measurename/profile-#1_legend.pdf}
\caption{{#2}{  } \measurename { }PROX/Parametric studies $\nu=1.0$}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu20/\measurename/profile-#1.pdf}
  \includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu20/\measurename/profile-#1_legend.pdf}
\caption{{#2}{  } \measurename { }PROX/Parametric studies $\nu=2.0$}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\figwidth]{../figure/REGUL/\measurename/profile-#1.pdf}
  \includegraphics[width=\figwidth]{../figure/REGUL/\measurename/profile-#1_legend.pdf}
