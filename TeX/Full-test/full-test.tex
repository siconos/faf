...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\figwidth]{../figure/PROX/NSN/InternalSolvers/{#3}/{#4}/\measurename/profile-#1.pdf}
  \includegraphics[width=\figwidth]{../figure/PROX/NSN/InternalSolvers/{#3}/{#4}/\measurename/profile-#1_legend.pdf}
\caption{{#2}{  } \measurename { }PROX/NSN/InternalSolvers}
\end{figure}
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\figwidth]{../figure/PROX/NSGS/InternalSolvers/{#3}/{#4}/\measurename/profile-#1.pdf}
  \includegraphics[width=\figwidth]{../figure/PROX/NSGS/InternalSolvers/{#3}/{#4}/\measurename/profile-#1_legend.pdf}
\caption{{#2}{  } \measurename { }PROX/NSGS/InternalSolvers}
\end{figure}
\begin{figure}[htbp]
  \centering
...
\subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/VI/UpdateRule/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}} 
...
\subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/NSGS/LocalTol/VI/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}} 
\subfloat[\scriptsize Cubes\_H8 II]
...
\subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/NSGS/LocalTol/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}} 
\subfloat[\scriptsize Cubes\_H8 II]
...
\subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/NSGS/rho/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}} 
\subfloat[\scriptsize Cubes\_H8 II]
...
\subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/NSGS/Shuffled/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}} 
\subfloat[\scriptsize Cubes\_H8 II]
...
\begin{figure}
  ...
  \subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/PSOR/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}} 
\subfloat[\scriptsize Cubes\_H8 II]
...
\section{Comparison of {\sf NSN-$\star$} algorithms}
...
\section{Comparison of PPA-NSN-AC algorithm with respect to  the step-size parameter $\sigma$, $\mu$}
...
\subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/PROX/NSN/InternalSolvers/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}}
\subfloat[\scriptsize Cubes\_H8 II]
...
\begin{figure}
  ...
  \subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu05/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}}
\subfloat[\scriptsize Cubes\_H8 II]
...
\begin{figure}
  ...
  \subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu10/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}}
\subfloat[\scriptsize Cubes\_H8 II]
...
\begin{figure}
  ...
  \subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/PROX/Parameters/nu20/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}}
\subfloat[\scriptsize Cubes\_H8 II]
...
\section{Comparison of optimization-based algorithms}
...
\subfloat[\scriptsize LowWall\_FEM]
   {\includegraphics[width=\figwidth]{../figure/COMP/zoom/1.0e-08/400/time/profile-LMGC_LowWall_FEM.pdf}}
\subfloat[\scriptsize Cubes\_H8 II]
...
\subfloat[\scriptsize Bridge\_PR]
   {\includegraphics[width=\figwidth]{../figure/COMP/zoom/1.0e-08/400/time/profile-LMGC_Bridge_PR.pdf}} \\
\subfloat[\scriptsize AqueducPR]
...
\subfloat[\scriptsize 100\_PR\_PerioBox]
   {\includegraphics[width=\figwidth]{../figure/COMP/large/1.0e-08/100/time/profile-LMGC_100_PR_PerioBox.pdf}} 
\subfloat[\scriptsize KaplasTower II]
...
\def\testname{LMGC_Bridge_PR}
\def\testnamechar{LMGC Bridge PR }
\test{\testname}{\testnamechar}{1.0e-08}{400}
...
\def\testname{Chute_local_problems}
\def\testnamechar{Chute\_local\_problems}
\test{\testname}{\testnamechar}{1.0e-08}{10}
