   ...
   Let $\mu$ be the coefficient of friction.  Let us define the Coulomb friction cone $K$ which is chosen as the
    ...
    \item and for the \tr{sliding case} that
      \begin{equation}
        ...
        u_{\t}  \neq 0,\quad r \in \partial K,  \frac{r_\t}{\|r_\t\|} = - \frac{u_\t}{\|u_\t\|}.
      \end{equation}
    \end{itemize}
  \end{block}
    ...
    \begin{equation}
      ...
      \left\{\begin{array}{llr}
          ...
          r \in K, u =0 &\text{ if } g_{\n} \leq 0 & \text{(sticking)}  \\
               r \in \partial K,u _\n=0,  \frac{r_\t}{\|r_\t\|} = - \frac{u_\t}{\|u_\t\|} &\text{ if } g_{\n} \leq 0 & \text{(sliding)}  \\
        \end{array}\right.
    \end{equation}
  \end{block}
...
\frame{
  ...
  \begin{block}{Second Order Cone Complementarity (SOCCP) formulation}
    ...
    \begin{itemize}
    \item Modified relative velocity $\hat u \in \RR^3$ defined by \citep{DeSaxce92}
      \begin{equation}
...
\frame{
  ...
  \item HBM, Flexible MBS, ...
  \end{itemize}
\end{block}
\ding{220}  These problems are really representative of a lot of applications with a possible linearization (Newton procedure)\\
\ding{220}  Nonlinear version is also possible\\
...
\frame{
  ...
  \begin{block}{Nonmonotone and nonsmooth SOCCP}
    \begin{equation}
      \label{eq:soccp3}
  ...
  \end{block}
   ...
   \begin{block}{Numerical methods}
     ...
     \item Many of them are adaptations of mathematical programming methods.
     \end{itemize}
   \end{block}
 }
