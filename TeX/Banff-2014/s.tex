...
\title[Coulomb friction and optimisation ]{Non-smooth dynamics and optimization:\\[2mm] solving the contact problem with friction using the interior point method and the numerical asymptotic method.\\[5mm]
