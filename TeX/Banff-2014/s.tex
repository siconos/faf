...
\title[Coulomb friction and optimisation ]{Nonsmooth dynamics and optimization.\\[2mm] Solving the contact problem with friction using \\[1mm]  interior point method and   asymptotic numerical method.\\[5mm]
  \large{CAS, Mines de Paris,   October 2025}}
...
%   \end{itemize}
% \end{frame}
\includepdf[pages={1-5}]{TRIPOP_generic.pdf}
\includepdf[pages={1-3}]{iIlustrationsApplications.pdf}
