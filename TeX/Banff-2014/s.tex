...
\begin{block}{Conclusions}
  ...
  \item Siconos/Numerics. A open source collection of solvers. \\
    {\url{https://github.com/siconos/siconos}}    use and contribute ...
  \item FCLIB: a collection of discrete 3D Frictional Contact (FC) problems \\
    {\href{https://github.com/FrictionalContactLibrary}{https://github.com/FrictionalContactLibrary}}    use and contribute ...
  \end{itemize}
\end{block}
}
