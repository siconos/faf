...
\frame{
  ...
  \end{itemize}
\end{block}
With fixed $\rho$, we get the Uzawa Algorithm of De Sacx\'e-Feng\hfill\tr{\sf{[FP-DS]}}
\begin{block}
...
\frame{
  ...
  \begin{block} {\sc Siconos/Numerics}
    ...
    \item Nonsmooth Newton technique: Alart-Curnier, Jean-Moreau, Natural map, Ficher-Bursmeister
