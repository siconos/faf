...
\begin{frame}
  ...
  \begin{block}{PhD thesis of Hoang Minh Nguyen(2025), with Paul Armand}
   Perturbation of the complementarity condition with a barrier parameter $\tau$\\[2mm]
    ...
    \end{block}
  \tr{\ding{220}} Extension to general frictional contact problems: nonsmooth interior point method
...
\begin{block}{Takeway}
  ...
  \ding{220} Need for a precise and fully tractable continuation method: ANM does the job
\end{block}
\end{frame}
