...
** TODO List of actions.  Last update <2016-03-20 Sun>
   ...
   + Paper. General Work :
     ...
     + Complete the introduction
       + Add a list of approach not discussed in the paper. leave it as future work.
       + Detail whre it is possible why some approaches are not discussed (IPM)
   ...
   + Devel and comparisons:    
     ...
     + Fclib and swig python tranalsation :MB:
